...
convert_motion_to_vmd("test_output/conqueror/conqueror_with_cam_motion.png", "test_output/exported/reconstruct.vmd")
preview_motion("test_output/exported/reconstruct.vmd", leg_ik=False)
